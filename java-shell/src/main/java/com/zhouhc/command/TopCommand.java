...
import com.zhouhc.command.subCommand.TBLFileToJsonArrayFileCommand;
...
@CommandLine.Command(name = "", synopsisSubcommandLabel = "command", description = "detailed message",
        //可能数量不确定是多少,官方推荐这么写
        subcommands = {
                TBLFileTOManyJsonFileCommand.class, TBLFileToJsonFileCommand.class, TBLFileToJsonArrayFileCommand.class
        })
